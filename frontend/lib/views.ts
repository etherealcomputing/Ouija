...
export type View = "console" | "brain" | "trends" | "devices" | "settings"
...
export const NAVIGATION: ViewDef[] = [
  ...
  { id: "devices", label: "Devices", icon: Cpu, shortcut: "4", roadmap: true },
  { id: "settings", label: "Settings", icon: Settings, shortcut: "5", roadmap: true },
]
